...
public class TicketModel extends BaseModel {
    ...
    public void getUserTicket(final OnPresenterListeners.OnModelListener<BaseBean<MessageBean>> listener){
        mSubscription= UserApi.getUserTicket(new Observer<BaseBean<MessageBean>>() {
            @Override
