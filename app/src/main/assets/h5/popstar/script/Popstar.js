...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/script/Popstar.es6");
/******/ })
/************************************************************************/
/******/ ({
...
var _Model = __webpack_require__(/*! ./core/Model.es6 */ "./src/script/core/Model.es6");

var _Model2 = _interopRequireDefault(_Model);

var _View = __webpack_require__(/*! ./core/View.es6 */ "./src/script/core/View.es6");

var _View2 = _interopRequireDefault(_View);

var _Control = __webpack_require__(/*! ./core/Control.es6 */ "./src/script/core/Control.es6");

var _Control2 = _interopRequireDefault(_Control);

var _externalGame = __webpack_require__(/*! ./externalGame.es6 */ "./src/script/externalGame.es6");
...
var Popstar = function () {
	...
	_createClass(Popstar, [{
		...
		value: function enter(level) {
			if (level === 0) _externalGame.popStarObserver.next({ start: true });
...
var _Event = __webpack_require__(/*! ../lib/Event.es6 */ "./src/script/lib/Event.es6");

var _Event2 = _interopRequireDefault(_Event);

var _timer = __webpack_require__(/*! ../lib/timer.es6 */ "./src/script/lib/timer.es6");
  ...
  function Constrol(model, view) {
    ...
    this.event.on("view-clean-all", function () {
      if (_this.total < _this.goal) {
        ...
        _externalGame.popStarObserver.next({ failed: true });
      }
      // 通关
      else {
...
var _shuffle = __webpack_require__(/*! ../lib/shuffle.es6 */ "./src/script/lib/shuffle.es6");

var _shuffle2 = _interopRequireDefault(_shuffle);

var _waveaverage = __webpack_require__(/*! ../lib/waveaverage.es6 */ "./src/script/lib/waveaverage.es6");
			...
			try {
				for (var _iterator = this.updatedColSet[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					...
					var start = colInfo.start,
					    ...
					    pitCount = colInfo.pitCount,
					    topPit = colInfo.topPit,
					    bottomPit = colInfo.bottomPit,
					    count = colInfo.count;
  ...
  */
		...
		value: function check() {
			...
			for (var _col = patternCol, len = this.wall.length; _col < len; ++_col) {
				var _colInfo2 = this.wall[_col];
				// 行索引 
				var _rowIndex = patternCol === _col ? patternRow - 1 : _colInfo2.end;
				// 向上扫描「行」
				for (var _row = _rowIndex; _row >= _colInfo2.start; --_row) {
...
__webpack_require__(/*! ../lib/pixi.extension */ "./src/script/lib/pixi.extension.js");
...
var view = function () {
  function view(_view) {
    ...
    Reflect.defineProperty(this, "partnerScore", {
      get: function get() {
        return _this._partnerScore || 0;
      },
      set: function set(value) {
        _this._partnerScore = value;
        _this.partnerScoreLabel.text = '\u961F\u53CB\u5206\u6570\uFF1A' + value;
        _this.totalScore = _this.total + _this.partnerScore;
    ...
    Reflect.defineProperty(this, "totalScore", {
      get: function get() {
        return _this._totalScore || 0;
      },
      set: function set(value) {
        _this._totalScore = value;
        _this.totalScoreLabel.text = '\u603B\u5206\uFF1A' + Number(_this._totalScore);
      }
    });
    ...
    Reflect.defineProperty(this, "resurgenceNum", {
      get: function get() {
        return _this._resurgenceNum || 0;
      },
      set: function set(value) {
        _this._resurgenceNum = value;
        _this.resurgenceLabel.text = '\u590D\u6D3B\u6B21\u6570\uFF1A' + value;
      }
    });
    // 消除信息
    ...
    this.game.addChild(this.level, this.goal, this.totalLabel, this.partnerScoreLabel, this.totalScoreLabel, this.cleanInfo, this.bountyLabel, this.starInfo, this.resurgenceLabel);
    ...
    // 加载图片
    PIXI.loader.add([{ name: "red", url: "images/red@2x.png" }, { name: "green", url: "images/green@2x.png" }, { name: "blue", url: "images/blue@2x.png" }, { name: "yellow", url: "images/yellow@2x.png" }, { name: "purple", url: "images/purple@2x.png" }, { name: "star_red", url: "images/star_red@2x.png" }, { name: "star_green", url: "images/star_green@2x.png" }, { name: "star_blue", url: "images/star_blue@2x.png" }, { name: "star_yellow", url: "images/star_yellow@2x.png" }, { name: "star_purple", url: "images/star_purple@2x.png" }, { name: "pause", url: "images/pause@2x.png" }, { name: "play", url: "images/play@2x.png" },
    // {name: "cover", url: "images/cover.jpg"},
    { name: "cover", url: "images/bg.png" }]).load(function () {
    ...
    value: function showTileScore(tile) {
      ...
      TweenMax.to(score, .4, {
        ...
        onComplete: function onComplete() {
          ...
          _externalGame.popStarObserver.next({ total: true });
        }
      });
...
exports.popStarObserver = undefined;

var _index = __webpack_require__(/*! rxjs/index */ "./node_modules/rxjs/index.js");

var popStarObserver = exports.popStarObserver = new _index.Subject();
...
var saveScoreArr = [1500, 5000, 7500, 10000, 12500]; // 奖命  阈值
// let saveScoreArr = [1500, 7000, 15000, 35000, 80000]   // 奖命  阈值
// let saveScoreArr = [1000, 4000, 7000, 10500, 145000]   // 奖命阈值
var saveThreshold = 0;
var bonusScoreArr = [10000, 20000, 30000, 50000, 100000]; //奖励阈值
var bonusThreshold = 0;

popStarObserver.subscribe(function (res) {
  if (res.start) {
  ...
  if (res.total) {
    ...
    if (_bridge) _bridge.callHandler('ToApp', JSON.stringify(_data), function (responseData) {});
    // 拯救队友
    if (saveThreshold <= saveScoreArr.length - 1) {
      if (score >= saveScoreArr[saveThreshold]) {
        ...
        if (_bridge) _bridge.callHandler('ToApp', JSON.stringify(_data2), function (responseData) {});
  ...
  if (res.leave) {
    ...
    if (_bridge) _bridge.callHandler('ToApp', JSON.stringify(_data4), function (responseData) {});
  }
});
...
/***/ "./src/script/lib/pixi.extension.js":
/*!******************************************!*\
  !*** ./src/script/lib/pixi.extension.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./src/script/lib/waveaverage.es6":
/*!****************************************!*\
  !*** ./src/script/lib/waveaverage.es6 ***!
  \****************************************/
/*! no static exports found */
...
/******/ });
//# sourceMappingURL=Popstar.js.map