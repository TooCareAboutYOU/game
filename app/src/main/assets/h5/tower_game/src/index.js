...
import {touchEventHandler} from './utils.js'
import {background} from './background.js'
import {lineAction, linePainter} from './line.js'
import {cloudAction, cloudPainter} from './cloud.js'
import {hookAction, hookPainter} from './hook.js'
...
window.TowerGame = (option = {}) => {
  ...
  game.setVariable(constant.failedCount, 4)
