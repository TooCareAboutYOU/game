...
function drawScoreboard () {
  ...
  if (gameState === 0) {
    ...
    renderText(trueCanvas.width / 2 + gdx + 6 * settings.scale, trueCanvas.height / 2 + gdy - 155 * settings.scale, 150, "#2c3e50", "六边形");
...
function pause (o) {
  ...
  if (gameState == -1) {
    ...
    $("#pauseBtn").attr("src", "./images/btn_resume.svg");
    // gameOverDisplay 时序问题
    if (!o) $('#overlay').fadeIn(300, 'linear');
